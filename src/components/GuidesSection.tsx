...
const videos = [
  {
    ...
    description: "Step-by-step walkthrough of the complete Azani Internet Service Provider database system — covering table design, relationships, forms, queries, and reports for KCSE Paper 451/3. Perfect for students starting their 2026 project.",
    badge: "Featured",
  },
  {
    id: "Zj57vFeaO-A",
    title: "Victory School Club — Milestone 2 (Database System)",
    description: "Learn how to build a fully functional MS Access database for the Victory School Club Membership System. Covers table structures, data entry forms, select queries, and auto-generated reports.",
    badge: "2024",
  },
  {
    id: "Rhp84_oP6bU",
    title: "Victory School Club — Milestone 1 (Documentation)",
    description: "Complete documentation guide: problem statement, system objectives, ER diagrams, data flow diagrams, data dictionary, and normalization — all following KNEC marking standards.",
    badge: "2024",
  },
  {
    id: "GMP0Fn3WJpk",
    title: "Uzima Borehole Drilling — Full Query Design",
    description: "Master query design in MS Access. This tutorial covers select queries, parameter queries, calculated fields, and action queries using the Uzima Borehole Drilling System as a real exam example.",
    badge: "2023",
  },
  {
    id: "i6kULAmtk1g",
    title: "Uzima Borehole Drilling — Table & Form Design",
    description: "Learn professional table design with proper field types, input masks, and validation rules. Then build user-friendly data entry forms with navigation buttons and search functionality.",
    badge: "2023",
  },
  {
    id: "vAOFnQ5OHWI",
    title: "Maringo Sports Club — Full Project Compilation",
    description: "Watch the entire KCSE 2023 Maringo Sports Club project from start to finish — documentation, database design, forms, queries, and report generation compiled into one comprehensive tutorial.",
    badge: "2023",
  },
];
