      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Button
              asChild
              className="bg-brand-purple hover:bg-brand-purple-dark font-semibold"
            >
              <a href="#download">
                Get Started
              </a>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-background/95 backdrop-blur-xl border-t border-border animate-fade-in">
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-2">
            ...
            <Button
              asChild
              className="mt-2 bg-brand-purple hover:bg-brand-purple-dark font-semibold"
            >
              <a href="#download" onClick={handleNavClick}>
                Get Started
              </a>
            </Button>
          </nav>
