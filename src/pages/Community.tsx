...
const Community = () => {
  ...
  if (selectedDiscussion) {
    return (
      <div className="flex min-h-screen flex-col">
        <SEOHead
          title={`${selectedDiscussion.title} | Community`}
          description={selectedDiscussion.content.slice(0, 160)}
        />
        <Header />
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Community | KCSE Project Discussion"
        description="Join the KCSE Computer Studies project community. Ask questions, share knowledge, and get help from fellow students."
        keywords={["KCSE", "community", "discussion", "project help", "Computer Studies"]}
      />
      <Header />
      <main className="flex-1 pt-16">
        {/* Hero Section */}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
                KCSE Project Discussion
              </h1>
              <p className="text-muted-foreground mb-6">
                Ask questions, share knowledge, and connect with fellow students working on their KCSE projects.
              </p>
              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {filteredDiscussions.map((discussion, index) => (
                    <div
                      key={discussion.id}
                      className="bg-card border border-border rounded-lg p-4 hover:border-primary/30 transition-colors cursor-pointer animate-fade-in"
